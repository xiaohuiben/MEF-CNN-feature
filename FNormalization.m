function norm_SIFTFeatureVector = FNormalization(CNNFeatureVector)
...
[ nrows, ncols, dimension ] = size( CNNFeatureVector );

% normalize SIFT descriptors
norm_SIFTFeatureVector = reshape( CNNFeatureVector, [nrows * ncols dimension ] );
